...
let category_options = {
    ...
    labels: ['Kỹ năng sống', 'Văn học', 'Kinh tế', 'Xã hội', 'Khoa học'],
    chart: {
        type: 'donut',
    },
    colors: ['#6ab04c', '#2980b9', '#f39c12', '#d35400', '#C71585']
}
...
let customer_options = {
    series: [{
        name: "Trực tiếp",
        data: [4000, 7000, 2000, 9000, 3600, 8000, 3000, 9100, 6000]
    },{
        name: "Online",
        data: [2000, 3000, 1000, 2000, 1600, 4000, 2000, 5100, 1000]
    }],
